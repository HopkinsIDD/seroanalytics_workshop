...
You can load this data, or adjust data like that below. 
...
Adjust the following code to apply the function.
...
```{r}
  ...
  #Adjust standard curve information. Based on your data. You can check that your answer from Q6 is in the correct format to use here. 
  standard_curve_values= data.frame(Sample= c("Std Curve wruv 1:80", "Std Curve wruv 1:40", "Std Curve wruv 1:20", "Std Curve wruv 1:10",
                             "Std Curve wruv 1:5", "Std Curve wruv 1:2.5", "Std Curve wruv 1:1.25", "Std Curve wruv 1:0.625"),
                                  Dilution= c(1/100, 1/200, 1/400, 1/800, 1/1600, 1/3200, 1/6400, 1/12800),
                              Location= c("89(1,A12)", "90(1,B12)", "91(1,C12)", "92(1,D12)", "93(1,E12)", "94(1,F12)", "95(1,G12)", "96(1,H12))"),
...
8. Look at this dataframe to ensure the function worked as you expected. Save this data frame. 
...
9. Redo steps 7 and 8 for any other raw plates you have.
...
```{r}
  View(plate_tidy)
  setwd("working_directory_location") #you can adjust this to save file in a different folder
  write.csv(plate_tidy, "Plate_tidt.csv", row.names = FALSE) #Adjust this to give file a different name (eg. Plate1, Plate2 tidy)
