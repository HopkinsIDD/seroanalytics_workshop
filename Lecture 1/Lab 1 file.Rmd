...
The output of the read and tidy function is a long dataframe with results of one antigen per row. It also includes the following variables: 
...
```{r run_read_and_tidy_plate1}
  ...
  file_name_plate2 <- "data/Raw Plate 2 dataset.csv"
