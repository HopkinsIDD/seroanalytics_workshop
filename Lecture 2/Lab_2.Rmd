...
getwd()
my_path <- 'COPY YOUR FILE PATH TO seroanalytics_workshop/Data FOLDER'
...
plate_1_tidy<-read_and_tidy(
                      file_name=paste(my_path, "Raw Plate 1 dataset.csv", sep="/"), 
                      plate_number=1, 
                      num_wells= 96, 
...
plate_2_tidy<-read_and_tidy(
                      file_name=file_name=paste(my_path, "Raw Plate 2 dataset.csv", sep="/"), 
                      plate_number=2, 
                      num_wells= 96, 
                      antigen_names = agx_names, 
                      control_samples= ctrls, 
...
plate_3_tidy<-read_and_tidy(
                      file_name=file_name=paste(my_path, "Raw Plate 3 dataset.csv", sep="/"), 
                      plate_number=3, 
                      num_wells= 96, 
                      antigen_names = agx_names, 
                      control_samples= ctrls, 
...
plate_4_tidy<-read_and_tidy(
                      file_name=file_name=paste(my_path, "Raw Plate 4 dataset.csv", sep="/"), 
                      plate_number=4, 
                      num_wells= 96, 
                      antigen_names = agx_names, 
                      control_samples= ctrls, 
