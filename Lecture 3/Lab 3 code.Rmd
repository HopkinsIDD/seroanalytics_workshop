...
If you are using your own data, look up the appropriate cutoff to use.
  ...
  a. Apply cutoff. How many people are seropositive according to this cutoff, and what percent of people are seropositive?
  
```{r applying_cutoff}

#Setting cutoff:
cutoff <- 156.94 #replace with your cutoff determined from 4a)
...
```
  ...
  b. For this antigen, remake the histogram showing sample MFI values and add a vertical line showing the cutoff. Do this on an untransformed and a log scale.
...
```  
  ...
  c. For this specific antigen, how would you interpret this seropositivity? 
  
  d. What do you think about using this cutoff method for this antigen? What are the assumptions that went into this cutoff method?
